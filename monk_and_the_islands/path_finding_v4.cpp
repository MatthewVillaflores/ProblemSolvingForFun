...
struct node_t{
	...
	node_t() : node_min_distance(10000000){}
...
int main() {
	...
	for (int i=0; i<test_cases; i++)
	{
		...
		{
			node_t* curr_node = bfs_queue.front(); bfs_queue.pop();
					...
					itr++)
			{
				...
				{
					curr_node->node_min_distance = next_node->node_min_distance+1;
				}
